...
@Component({
  selector: 'app-view-load-data',
  standalone: false,
  templateUrl: './view-load-data.component.html',
  styleUrl: './view-load-data.component.scss'
})
export class ViewLoadDataComponent extends BaseComponent {
